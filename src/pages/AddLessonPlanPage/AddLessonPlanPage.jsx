...
export default function AddLessonPlanPage({setActiveModule, setPopulatedModules, populatedModules}) {
    const [index, setIndex] = useState([])
    const[activeLessonPlan, setActiveLessonPlan] = useState(null)
    
    const indexLessonPlans = index.map(LessonPlan => <LessonPlaner LessonPlan={LessonPlan} key={LessonPlan._id} addLessonPlan={addLessonPlan} viewLessonPlan={viewLessonPlan}/>)
    ...
    function handleUpdate(updatedLessonPlan){
        ...
        const idx = indexCopy.findIndex(LessonPlan => LessonPlan._id === updatedLessonPlan._id)
    ...
    function handleRemove(deletedLessonPlanId){
        const indexCopy = [...index]
        const idx = indexCopy.findIndex(LessonPlan => LessonPlan._id === deletedLessonPlanId)
    ...
    async function viewLessonPlan(LessonPlan){
        ...
        setActiveLessonPlan(<ViewLessonPlanForm LessonPlan={viewLessonPlan} handleUpdate={handleUpdate} handleRemove={handleRemove}/>)
    }
