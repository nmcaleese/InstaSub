            ...
            <Form autoComplete="off" onSubmit={handleSubmit} > 
              <Row>
                <Col>
                  ...
                  <Form.Group className="mb-3" controlId={lesson.subject}>
                      <Form.Control type='subject' placeholder='What is the subject of this lesson?' name='subject' onChange={handleChange} value={lesson.subject} required />
                  </Form.Group>
                </Col>
              </Row>
              <Form.Group className="mb-3" controlId={lesson.content}>
                ...
                <div className="d-grid gap-2">
                  <Button  variant='success' type="submit" disabled={!(lesson.title && lesson.subject && lesson.content)}>Create</Button>
                </div>
            </Form> 
