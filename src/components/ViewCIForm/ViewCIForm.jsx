                ...
                <Form autoComplete="off" onSubmit={handleSubmit}>
                  <Row>
                    <Col>
                      <Form.Group
                        className="mb-3"
                        controlId={instructions.class}
                      >
                        <Form.Control
                          type="text"
                          placeholder="What class is it for?"
                          name="class"
                          onChange={handleChange}
                          value={instructions.class}
                          required
                        />
                      </Form.Group>
                    </Col>
                    <Col>
                      <Form.Group
                        className="mb-3"
                        controlId={instructions.period}
                      >
                        <Form.Control
                          type="text"
                          placeholder="What period?"
                          name="period"
                          onChange={handleChange}
                          value={instructions.period}
                          required
                        />
                      </Form.Group>
                    </Col>
                  ...
                  <Form.Group
                    className="mb-3"
                    controlId={instructions.classroomInstructions}
                  >
                    <Form.Control
                      as="textarea"
                      rows={3}
                      placeholder="What does your sub need to know about the class?"
                      name="classroomInstructions"
                      onChange={handleChange}
                      value={instructions.classroomInstructions}
                      required
                    />
                  </Form.Group>
                  <br />
